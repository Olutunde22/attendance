                ...
                <div className="max-w-md w-full space-y-8 px-12 bg-white py-8 shadow-lg rounded-xl">
                    ...
                    >
                        {({ isSubmitting, errors, touched }) => (
                            <Form>
                                {error ? <div className='transform motion-safe:hover:scale-110 flex text-red-700 bg-red-100'><div className="text-sm md:text-normal inline">{error}</div> </div> : null}
                                {loginFields.map((field) => (
                                    <div className="my-2" key={field.id}>
                                        ...
                                        <Field
                                            ...
                                            className={`relative block w-full px-3 py-3 border ${errors[field.name] && touched[field.name]
